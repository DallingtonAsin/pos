            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <form class="form" method="post"
                        action="{{ route('company.add_or_update', $company->is_registered ? $company->id : 0) }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Enter company name" name="name"
                                value="<?= isset($company) ? $company->name : '' ?>" autocomplete="off">
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="email" placeholder="Enter email"
                                value="<?= isset($company) ? $company->email : '' ?>" autocomplete="off">
                            @error('email')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Enter address" name="address"
                                value="<?= isset($company) ? $company->address : '' ?>" autocomplete="off">
                            @error('address')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Enter abbreviation" name="abbrev"
                                value="<?= isset($company) ? $company->abbrev : '' ?>" autocomplete="off">
                        </div>
