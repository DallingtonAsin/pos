                            ...
                            <form name="SaleForm" id="SaleForm">
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control item-name messageArray text-dark"
                                            value="">
                                    </div>

                                    <div class="form-group">
                                        <span>Qty</span>
                                        <input type="text" class="form-control qty messageArray text-dark"
                                            value="">
                                    </div>

                                    <div class="form-group">
                                        <span>Selling Price</span>
                                        <input type="text" class="form-control sprice messageArray text-dark"
                                            value="">
                                    </div>

                                    <div class="form-group">
                                        <span>Total cost</span>
                                        <input type="text" class="form-control tcost messageArray text-dark"
                                            value="">
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <span>Discount</span>
                                            <input type="text" class="form-control discount messageArray text-dark"
                                                value="">
                                        </div>

                                        <div class="col-lg-6">
                                            <span>Sold at</span>
                                            <input type="text" class="form-control amount messageArray text-danger"
                                                value="">
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <span>Customer</span>
                                            <input type="text" class="form-control customer messageArray text-dark"
                                                value="">
                                        </div>

                                        <div class="col-lg-6">
                                            <span>Cashier</span>
                                            <input type="text" class="form-control cashier messageArray text-dark"
                                                value="">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="date_of_sale"
                                            class="form-control date messageArray text-dark" value="">
                                    </div>
