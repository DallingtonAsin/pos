        ...
        <div class="panel-heading">
            <div class="panel-title nunito-font">
                <div class="row nunito-font">
                    ...
                    <div class="col-lg-4">
                        <label>Sales taken on credit</label>
                        <span class="badge nunito-font no_of_credit_sales">
                            @isset($no_of_credit_sales)
                                {{ number_format($no_of_credit_sales) }}
                            @endisset
                        </span>
                    </div>

                    @can('isAdmin')
                        @isset($outstanding_credit_sales)
                            <div class="col-lg-4 outstanding_credit_sales">
                                <label>Outstanding credit sales: UGX.</label>
                                <strong class="text-danger totl_sales volume">{{ number_format($outstanding_credit_sales) }}</strong>
                            </div>
                        @endisset
                    @endcan

                    @isset($today_credit_sales)
                        <div class="col-lg-4 today_credit_sales">
                                    <strong> Today's credit sales: UGX.</strong>
                                    <strong class="text-danger volume">{{ number_format($today_credit_sales) }}</strong>
                        </div>
                    @endisset
                </div>
            </div>
        ...
        <div class="panel-body">
            ...
            <form>
                <div class="row nunito-font">
                    ...
                    <div class="col-md-4">
                        <button type="button" class="btn btn-sm btn-success filterSalesBtn" id="filterSalesBtn">Filter
                            sales</button>
                    </div>
                </div>
            </form>
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                    ...
                    <div class="modal-content nunito-font border border-custom-dark rounded-0">
                        <div class="modal-header  text-center">
                            ...
                            <button type="button" class="close view-close text-white" data-dismiss="modal"
                                aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                            ...
                            <form name="SaleForm" id="SaleForm">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <span>Discount</span>
                                            <input type="text" class="form-control discount  text-dark"
                                                value="">
                                        </div>

                                        <div class="col-lg-6">
                                            <span>Sold at</span>
                                            <input type="text" class="form-control amount  text-danger"
                                                value="">
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <span>Customer</span>
                                            <input type="text" class="form-control customer  text-dark"
                                                value="">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="date_of_sale" class="form-control date  text-dark"
                                            value="">
                                    </div>

                                    <div class="form-group">
                                        <button type="submit" class="btn btn-success addSaleBtn"
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            function ResetTblInfo(response) {
                ...
                (netWorth > 0) ?
                $('.net_profit').html(netWorth): $('.net_loss').html(netWorth);
