...
@section('content')
    ...
    <!--Add customers -->
    <div class="modal fade nunito-font addCustomersModal" id="addCustomersModal" tabindex="-1" role="dialog"
            ...
            <div class="modal-content">
                ...
                <form name="customers" id="CustomersForm">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-success AddcustomerBtn"
                                name="AddcustomerBtn">Save</button>
...
<script src="https://cdn.datatables.net/buttons/1.0.3/js/dataTables.buttons.min.js"></script> --}}
    ...
    <script>
        ...
        let table = $('#customers-table');
        let title = "List of registered customers in the system";
