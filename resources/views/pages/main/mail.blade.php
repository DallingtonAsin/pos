            ...
            <form class="form" method="post" action="{{ route('mail.store') }}" enctype='multipart/form-data'>
                ...
                <div class="row">
                    <div class="col-md-3 mt-4">
                        ...
                        <input type="radio" id='Cno' class='radioBtn noBtn' name="toAllCashiers" value="no"
                            checked>
                    ...
                    <div class="col-md-3 mt-4">
                        ...
                        <input type="radio" id='Mno' class='radioBtn noBtn' name="toAllManagers" value="no"
                            checked>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control   @error('senderName') is-invalid @enderror"
                            value="{{ Auth::user()->name }}" name="senderName" placeholder="type your name"
                            value="{{ Auth::user()->name }}" autocomplete="off" id='sender' spellcheck="false">
                    </div>
                    @error('senderName')
                ...
                <div class="form-group RecipientNameDiv">
                    ...
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                        <input type="text" class="form-control " name="receiverName" placeholder="type recipient's name"
                            id='recipient' value="{{ old('receiverName') }}" autocomplete="off" spellcheck="false">
                    </div>
                    @error('receiverName')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                ...
                <div class="form-group RecipientEmailDiv">
                    ...
                    <div class="input-group">
                        ...
                        <input type="email" class="form-control " placeholder="type recepient's email"
                            name="receiverEmail" value="{{ old('receiverEmail') }}" id='receiverEmail' autocomplete="on">
                    </div>
                    @error('receiverEmail')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-8">
                        ...
                        <textarea class="form-control " id="email-message" value="{{ old('message') }}" name="message" spellcheck="true"
                    ...
                    <div class="col-md-4 pt-4">
                        ...
                        <input type="file" id='attachment' class="form-control-file " name="email-attachment[]"
                            multiple>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <input type="submit" id='sendMailBtn' class="btn overview-item--c2 text-white nunito-font"
                            value="Send Email">
                    </div>
                    <div class="col-lg-9">
