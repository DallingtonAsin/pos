        ...
        <div class="col-lg-2">
         ...
         <ul class="dropdown-menu">
                ...
                <li>
                  ...
                  id="removeAllStockCats"> Delete all stock categories</a>
                </li>
                @endcan
  ...
  <div class="modal fade nunito-font" id="importCategories" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        enctype="multipart/form-data" name="importCategoriesForm" >
        @csrf
   ...
   buttons:{
     confirm:function(){
       ...
       return $.ajax({
         ...
         $.alert({
           title: 'Response',
           content:"Categories of stock not deleted:"+data.fail,
         });
         console.log(data);
