    ...
    <div class="panel panel-default">
      ...
      nunito-font" href="javascript:void(0)"
        ...
        <div class="panel-body">
            ...
            <!--Add new Stock -->
            <div class="modal fade nunito-font" id="addStockModal" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-content">
                        ...
                        <form name="StockForm" id="StockForm">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-success addStockBtn"
            ...
            <!--Import Stock -->
            <div class="modal fade nunito-font" id="importStock" tabindex="-1" role="dialog"
                aria-labelledby="myModalLabel">
                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                    <div class="modal-content">
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-success delete-ok-btn"
